                            ...
                            <div class="w-full px-4 md:w-7/12 lg:w-9/12">
                                <div class="flex flex-wrap items-center -mx-4">
                                    <div class="w-full px-4 lg:w-9/12">
                                        ...
                                        <div class="flex items-center mt-6 text-sm gap-x-6 text-slate-grey">
                                            <div class="flex items-center">
                                                ...
                                                <div class="text-14 lh-1">{{ $book->year_published }}</div>
                                            </div>
                                            <div class="flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2"
                                                ...
                                                <div class="text-14 lh-1">{{ $book->publisher }}</div>
                                            </div>
                                            <div class="flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    ...
                                    <div
                                        ...
                                        <form action="/books/{{ $book->id_book }}/wishlist" method="POST">
                                            @csrf

                                            <button type="submit">
                                                <div class="text-2xl font-semibold">
                                                    @if ($book->wishlists()->where('id_user', auth()->user()->id_user)->first())
                                                        <input type="hidden" name="id_book_wishlist"
                                                            value="{{ $book->wishlists()->firstWhere('id_user', auth()->user()->id_user)->id_book_wishlist }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                            fill="currentColor" class="w-7 h-7 text-red-500">
                                                            <path
                                        ...
                                        <a class="inline-flex items-center justify-center h-10 px-4 py-3 font-medium text-center transition-colors duration-300 border-2 border-transparent rounded-md disabled:pointer-events-none disabled:opacity-80 bg-dodger-blue/10 text-dodger-blue hover:bg-dodger-blue/20 lg:mt-4"
                                            href="/books/{{ $book->id_book }}">See Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
