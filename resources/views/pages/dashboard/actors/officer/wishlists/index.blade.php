                                    ...
                                    <div class="d-flex">
                                        <div class="me-2">
                                            <a class="px-2 pt-2 btn btn-danger" data-confirm-wishlist-destroy="true"
                                                data-unique="{{ $wishlist->id_book_wishlist }}">
                                        ...
                                        <div class="me-2">
                                            <a href="/books/{{ $wishlist->book->id_book }}" class="px-2 pt-2 btn btn-info">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <div class="me-2">
                                            <a href="/books/{{ $wishlist->book->id_book }}"
