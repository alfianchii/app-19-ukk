        ...
        <div class="row">
            <div class="order-last col-12 col-md-6 order-md-1">
                ...
                <p class="text-subtitle text-muted">
                    Here are all the reviews made by you for a book.
                </p>
                <hr>
            </div>
                        ...
                        @forelse ($yourReviews as $review)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="me-2">
                                            <a href="/dashboard/reviews/{{ $review->id_book_review }}/edit"
                                        ...
                                        <div class="me-2">
                                            <a class="px-2 pt-2 btn btn-danger" data-confirm-your-review-destroy="true"
                                                data-unique="{{ $review->id_book_review }}">
                                        ...
                                        <div class="me-2">
                                            <a href="/books/{{ $review->book->id_book }}" class="px-2 pt-2 btn btn-info">
                                                <span class="select-all fa-fw fa-lg fas"></span>
                                            </a>
                                        </div>
                                    </div>
