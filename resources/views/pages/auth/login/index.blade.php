        ...
        <div class="mt-16">
            ...
            <div class="flex flex-col p-10 mt-10 bg-white border-t-2 rounded-lg shadow-2xl border-t-dodger-blue">
                ...
                <div class="mt-8">
                    ...
                    <p class="text-slate-grey">Input your username and password.</p>
                </div>
            ...
            <div class="mt-12 text-center">
                <p class="text-sm text-slate-grey">Don’t have an account? <a href="/register"
                        class="text-royal-blue">Create one!</a></p>
            </div>
